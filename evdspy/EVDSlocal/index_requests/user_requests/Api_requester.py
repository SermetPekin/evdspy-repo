...
# ....................................................................... ApiRequester
class ApiRequesterNoProxy:
    def __init__(self, url_builder: UrlBuilder, proxy_manager: ProxyManager = None ):
        self.url_builder = url_builder
        self.proxy_manager = None 
        self.proxies = None # self.proxy_manager.get_proxies()
        self.url = self.url_builder.url
        self.response = None
...
""")
    ...
    def request(self) -> Any:
        ...
        if api_key is False:
            ...
            if PytestTesting().is_testing():
                raise NotImplementedError
        proxies = None #  self.proxy_manager.get_proxies()
